...
function calendarDateTimeToString( date ) {
	...
	return calendarToString( date.getFullYear(), month, day, hour, minute );
}
...
function calendarToString( year=null, month=null, day=null, hour=null, minute=null ) {
	...
	if( hour !== null && minute !== null ) {
		...
		date += ' ' + hourPadding + hour + ":" + minutePadding + minute + ":00"; 
	}
	return date;
}
